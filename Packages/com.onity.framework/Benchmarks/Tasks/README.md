...
The tracker attribution variant enables `Profiler.enableAllocationCallstacks`
in the allocation pass and stores the `GC.Alloc` callstacks for all eight
pending Onity samples with tracking on and off. It rejects a sample when its
callstack bytes differ from its marker bytes. The [baseline evidence](https://github.com/furkantokkan/Onity/blob/d585251/docs/assets/benchmarks/onity-whenall-tracker-attribution-ba2c72c-2026-09-24-summary.md)
and [static-callback candidate report](../../../../docs/assets/benchmarks/onity-whenall-tracker-static-callback-dcdcb51-2026-09-24-summary.md)
record the 148 B/op allocation change and remaining context-capture cost.
