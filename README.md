...
```
https://github.com/furkantokkan/Onity.git?path=/Packages/com.onity.framework#v0.3.13
```
...
(`#upm` tracks the latest package; use the `?path=/Packages/com.onity.framework#v0.3.13` form to pin a specific release.)
