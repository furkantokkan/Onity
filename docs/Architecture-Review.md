...
| 2 | High | **Stale test-count claim.** Project brief and any "203/203" references undercount the suite (363 test attributes now). | State the live count where it appears, or reference "the full EditMode suite" without a frozen number. Doc only. |
